...
<figure style="max-width:780px; margin:1.6em auto; text-align:center;">
  <img src="/assets/img/transformer/fig0_genealogy.png" alt="Transformer의 계보적 위치 다이어그램" style="width:100%;">
...
<figure style="max-width:760px; margin:1.5em auto; text-align:center;">
  <img src="/assets/img/transformer/fig2_attention.png" alt="Scaled Dot-Product Attention과 Multi-Head Attention 도식" style="width:100%;">
...
<div style="text-align:center; margin:1.1em 0;"><img src="/assets/img/transformer/eq_attention.png" alt="scaled dot-product attention 수식" style="max-width:620px; width:92%;"></div>
...
<div style="text-align:center; margin:1.0em 0;"><img src="/assets/img/transformer/eq_variance.png" alt="q와 k 내적의 평균과 분산" style="max-width:560px; width:90%;"></div>
...
<div style="text-align:center; margin:1.1em 0;"><img src="/assets/img/transformer/eq_multihead.png" alt="multi-head attention 수식" style="max-width:680px; width:94%;"></div>
...
<div style="text-align:center; margin:1.1em 0;"><img src="/assets/img/transformer/eq_ffn.png" alt="position-wise feed-forward network 수식" style="max-width:560px; width:90%;"></div>
...
<div style="text-align:center; margin:1.1em 0;"><img src="/assets/img/transformer/eq_posenc.png" alt="sinusoidal positional encoding 수식" style="max-width:620px; width:92%;"></div>
...
<figure style="max-width:520px; margin:1.5em auto; text-align:center;">
  <img src="/assets/img/transformer/fig1_architecture.png" alt="Transformer 인코더-디코더 전체 아키텍처" style="width:100%;">
...
<div style="text-align:center; margin:1.0em 0;"><img src="/assets/img/transformer/eq_sublayer.png" alt="Post-LN: LayerNorm(x + Sublayer(x))" style="max-width:420px; width:78%;"></div>
...
<figure style="max-width:720px; margin:1.5em auto; text-align:center;">
  <img src="/assets/img/transformer/fig3_attention_viz.png" alt="장거리 의존성을 따라가는 attention 시각화" style="width:100%;">
...
<figure style="max-width:780px; margin:1.4em auto; text-align:center;">
  <img src="/assets/img/transformer/fig0_genealogy.png" alt="Transformer 계보도 (재게시)" style="width:100%;">
</figure>
